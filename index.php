    ...
    <head>
        ...
        <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            .setup-prompt { background: white; border-radius: 12px; box-shadow: 0 20px 60px rgba(0,0,0,0.3); max-width: 600px; padding: 40px; text-align: center; }
            ...
            .btn { display: inline-block; background: #667eea; color: white; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: 500; font-size: 16px; transition: background 0.2s; }
            .btn:hover { background: #5568d3; }
            .btn-secondary { background: #e5e7eb; color: #374151; margin-left: 12px; }
            .btn-secondary:hover { background: #d1d5db; }
            .steps { text-align: left; background: #f9fafb; border-radius: 8px; padding: 24px; margin-top: 24px; }
            .steps h3 { font-size: 18px; color: #1f2937; margin-bottom: 16px; }
            .steps ol { padding-left: 20px; }
            .steps li { color: #4b5563; margin-bottom: 12px; line-height: 1.6; }
            .steps code { background: #fff; padding: 2px 6px; border-radius: 4px; font-size: 14px; color: #667eea; }
        </style>
    </head>
    <body>
